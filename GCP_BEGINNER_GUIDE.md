...
Máy này dùng để chạy các script điều khiển.
...
Do đó, trước khi muốn chạy file `.py`, bạn chỉ cần gõ lại lệnh kích hoạt ở Bước 3 (`source recsys_env/bin/activate`) là được nhé!
