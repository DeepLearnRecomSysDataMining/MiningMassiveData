...
def collect_related_links(driver, url, category_name):
    ...
    try:
        ...
        try:
            ...
            # Quét ASIN riêng trong vùng PPD (chủ yếu là các biến thể sản phẩm/swatches)
            ppd_items = extract_asins_from_visible_dom(ppd_section, category_name)
            all_page_items.update(ppd_items)
        except NoSuchElementException:
            logging.warning(f"        ⚠️ Không tìm thấy vùng id='ppd' bên trong dp-container.")
